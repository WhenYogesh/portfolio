...
import projectImage1 from "../assets/ml1.jpg";
...
const ProjectCard = ({ title, description, image, reverse }: ProjectCardProps) => (
  <div
  ...
  >
    <div className="md:w-1/2 w-full px-8 py-10 flex flex-col justify-center items-center md:items-start text-center md:text-left">
      ...
      <button className="border border-gray-800 text-black px-4 py-2 rounded-md text-sm hover:bg-yellow-400 transition font-roboto">
        View Project
      </button>
    </div>
...
const ProjectsSection = () => {
  return (
    <section id="projects" className="py-24 px-4 bg-[#f6f6f6] scroll-mt-20">
